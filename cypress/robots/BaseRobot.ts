...
export abstract class BaseEyes {
  seesImage() {
    cy.get("[data-testid=bookimage]").should("be.visible");
    return this;
  }
  ...
  seesBookDescription() {
    cy.get("[data-testid=bookDescription]").should("be.visible");
    return this;
  }

  seesAuthor() {
    cy.get("[data-testid=author]").should("be.visible");
    return this;
  }

  seesAuthorDescription() {
    cy.get("[data-testid=authorDescription]").should("be.visible");
    return this;
  }

  seesRecommendations() {
    cy.get("[data-testid=recommendations-header]").should("be.visible");
    return this;
  }
...
export class BaseHands {
  ...
  clickOnBookMark() {
    cy.get("[role=icon]").click({ multiple: true });
    return this;
  }
